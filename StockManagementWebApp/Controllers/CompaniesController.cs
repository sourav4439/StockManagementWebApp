...
namespace StockManagementWebApp.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,RegistrationCode,Name,CategoryId")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,RegistrationCode,Name,CategoryId")] Company company)
        {
            if (ModelState.IsValid)
            {
